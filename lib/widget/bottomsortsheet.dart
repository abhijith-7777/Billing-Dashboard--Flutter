...
class AnimatedSortBottomSheet extends StatelessWidget {
  final int selectedIndex;
  final void Function(int index)? onSelect;

  const AnimatedSortBottomSheet({
    super.key,
  ...
  final List<Map<String, dynamic>> sortOptions = const [
    {"icon": "assets/image/sort.png", "text": "Newest to Oldest"},
    {"icon": "assets/image/sort.png", "text": "Oldest to Newest"},
    {"icon": "assets/image/AtoZ.png", "text": "A to Z"},
    {"icon": "assets/image/ZtoA.png", "text": "Z to A"},
  ];
